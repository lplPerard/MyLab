...
includefiles = ['Parameters.json', 'Metadata.json', 'Error.json', 'Devices.json',
                ...
                'HMC8042.png', '2220-30-1.png', 'VT4002_EMC.png', '33500B.png', '8845A.png',
                'RTM1054.png', 'RTM3004.png', 'MSO2014.png', 'HMO3004.png', 'DL9040.png',
                'icon.ico', 'diode.png', 'diode_grey.png', 'continuity.png', 'continuity_grey.png', 'delete.png', 'play.png', 'pause.png', 'next.png', 'stop.png', 'empty.png', 'breakpoint.png']
